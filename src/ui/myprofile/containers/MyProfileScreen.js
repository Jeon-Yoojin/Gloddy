...
const Profile = ({ name, address, age }) => {
    return (
        <View style={[{ paddingVertical: 25, alignItems: 'center' }, styles.subContainer]}>
            ...
            <View style={{ alignItems: 'flex-start' }}>
                ...
                <Text style={{ fontSize: 14, color: '#AAAAAA', alignSelf: 'center'}}>남 ㅣ 20세ㅣ 경희대학교 서울캠퍼스</Text>
                <Text style={{ fontSize: 10, color: '#AAAAAA', alignSelf: 'center'}}>2022년 01월 01일 가입</Text>
            </View>
    ...
    return (
        <View style={[{ flexDirection: 'row', paddingVertical: 10 }]}>
            <View style={{ width: '50%', flexDirection: 'row'}}>
                <View style={{backgroundColor: '#F7F7F7', width: 47, height: 47, borderRadius: 23.5, marginHorizontal: 10}}/>
                <View>
            ...
            <View style={{ width: '50%', flexDirection: 'row'}}>
                ...
                <View>
                    ...
                    <Text style={[styles.text, { fontSize: 20, fontWeight: 'bold' }]}>111</Text>
                </View>
            </View>
        </View >
    )
...
const SelfIntro = () => {
    return(
        <View style={{marginHorizontal: 20, marginVertical: 5}}>
            ...
            <View style={{backgroundColor: '#FFFFFF', paddingHorizontal: 20, paddingVertical: 16, borderRadius: 10,}}>
                <Text style={{fontWeight: '500', fontSize: 12, lineHeight: 24, color: '#3A3A3A'}}>안녕하세요, 경희대학교에 재학중인 글로디 관리자 입니다. 잘 부탁 드려요 !</Text>
            </View>
        </View>
    )
}
...
const PersonalityCard = ({personality}) => {
    return(
        <View style={{paddingVertical: 2, paddingHorizontal: 14, borderRadius: 14, backgroundColor: '#FFFFFF', marginHorizontal: 4}}>
            <Text style={{fontSize: 12, lineHeight: 24, fontWeight: 'bold'}}>{personality}</Text>
        </View>
    )
}
